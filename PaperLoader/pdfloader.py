...
# -*- coding: utf-8 -*-
r"""
@DATE: 2025-03-02 16:43:09
@File: PaperLoader/pdfloader.py
@IDE: vscode
@Description:
    PDF论文加载类
"""
...
class PdfPaperLoader(AbPaperLoader):
    def __init__(self,api:str,filetype:str="pdf"):
    ...
    def convert_paper(self,vlapi,output_type:str="markdown",lang:str="English"):
        ...
        request_type = f"application/{self.filetype}"
...
if __name__ == '__main__':    
    ...
    filepath = '../TestPaper/21414000_21414000_（梁晓琦）基于HTML5的移动学习平台设计与实现_2018-03-17-16-43-37.pdf'
    filename = '基于HTML5的移动学习平台设计与实现.pdf'
...
#Test page:66 time:18s
#Test page:75 time:20s